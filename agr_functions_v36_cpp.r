...
#      - added function attrdl, previously available in the package FluMoDL
...
# Function to calculate attributable fractions and numbers from dlnm models
# Original function and documentation written by Antonio Gasparrini and available at: https://github.com/gasparrini/2014_gasparrini_BMCmrm_Rcodedata/blob/master/attrdl.R
# Slightly amended by Theodore Lytras for use with FluMoDL R package.

attrdl <- function (x, basis, cases, model = NULL, coef = NULL, vcov = NULL, 
