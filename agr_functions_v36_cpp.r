...
#   'X' is a data.frame at disaggregated resolution with (i) period indicator and (ii) exposures/covariates ###JB###
...
fit_aggregate_cpp <- function( Y,
  ...
  if ( error_code == 0 ) {
    ...
    # If the Disaggregated|Disaggregated Model Did Not Converge, Fit it Again until Convergence up to 'ntryini' Times ###JB###
    try_iter <- 1
